...
/*Mapping led pin to the correct device pins*/
#define BOARD_BLUE_GPIO_PORT_INSTANCE     2U
#define BOARD_BLUE_GPIO_PIN               0U
#define BOARD_BLUE_GPIO_PIN_DEFAULT_STATE 0U

/*Mapping led pin to the correct device pins*/
#define BOARD_GREEN_GPIO_PORT_INSTANCE     2U
#define BOARD_GREEN_GPIO_PIN               6U
#define BOARD_GREEN_GPIO_PIN_DEFAULT_STATE 0U
...
#endif
#if defined(gBoardLedblue_d) && (gBoardLedBlue_d > 0)
#define gBoardLedBlueHdl ((led_handle_t)g_ledHandle[0])
#endif
#if defined(gBoardLedYellow_d) && (gBoardLedYellow_d > 0)
#define gBoardLedYellowHdl ((led_handle_t)g_ledHandle[1])
#endif
#if defined(gBoardLedGreen_d) && (gBoardLedGreen_d > 0)
#define gBoardLedGreenHdl ((led_handle_t)g_ledHandle[1])
#endif
#endif
 ...
 *
 * This function is used to initialize blue LED.
 *
 * @param ledHandle The led handle .
 * Example below shows how to use this API to initialize PB1 LED.
 *  @code
...
/*!
 * @brief Uninitialize blue LED .
 *
 * This function is used to uninitialize blue LED when going to low power mode
 * Turns off the LED and sets port as input
 *
 * @param ledHandle The led handle.
 */
...
/*!
 * @brief Initialize green LED
 *
 * This function is used to initialize green LED.
 *
 * @param ledHandle The led handle .
 * Example below shows how to use this API to initialize PB1 LED.
 *  @code
 ...
 *  @endcode
 */
void BOARD_InitGreenLed(led_handle_t ledHandle);

/*!
 * @brief Uninitialize green LED .
 *
 * This function is used to uninitialize green LED when going to low power mode
 * Turns off the LED and sets port as input
 *
 * @param ledHandle The led handle.
 */
void BOARD_UnInitGreenLed(led_handle_t ledHandle);

...
/* For backward compatibility, because DEFAULT_APP_UART is defined in app_preinclude.h
 * for some projects, propagate its definition to BOARD_APP_UART_INSTANCE
 */
#ifdef DEFAULT_APP_UART
...
#define BOARD_APP_UART_CLKSRC       (clock_ip_src_t)BOARD_UART_CLKSRC
 ...
 * the UART */
#define BOARD_APP2_UART_CLKSRC       (clock_ip_src_t)BOARD_UART_CLKSRC
...
#if !defined BOARD_DEBUG_UART_INSTANCE
...
#define BOARD_DEBUG_UART_CLKSRC   (clock_ip_src_t)BOARD_UART_CLKSRC
#endif /* BOARD_DEBUG_UART_CLKSRC */

#ifndef BOARD_DEBUG_UART_CLK_FREQ
#define BOARD_DEBUG_UART_CLK_FREQ CLOCK_GetIpFreq(BOARD_DEBUG_UART_CLK)

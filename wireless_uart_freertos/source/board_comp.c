                    ...
                    .gpio =
                        {
                            ...
                            kHAL_GpioDirectionOut,
#endif
                            BOARD_BLUE_GPIO_PIN_DEFAULT_STATE,
                            BOARD_BLUE_GPIO_PORT_INSTANCE,
                            BOARD_BLUE_GPIO_PIN,
                        },
                },
        },
...
static const led_config_t g_GreenLedConfig = {
    .type = kLED_TypeMonochrome,
    .ledMonochrome =
        {
            .monochromePin =
                    ...
                    .gpio =
                        {
                            ...
                            kHAL_GpioDirectionOut,
#endif
                            BOARD_GREEN_GPIO_PIN_DEFAULT_STATE,
                            BOARD_GREEN_GPIO_PORT_INSTANCE,
                            BOARD_GREEN_GPIO_PIN,
                        },
                },
        },
};
...
void BOARD_InitGreenLed(led_handle_t ledHandle)
{
    ...
    ret = LED_Init(ledHandle, &g_GreenLedConfig);
    assert(kStatus_LED_Success == ret);
    (void)ret;
}

...
/*! \brief Change Default amplifier current selected for 32MHz crystal,
      will be used by hardware_init.c file during initialization */
#ifndef BOARD_32MHZ_XTAL_ISEL_VALUE
#define BOARD_32MHZ_XTAL_ISEL_VALUE 5U
#endif
...
#if defined BOARD_IS_FRDM_MCXW71_SCH_91744_RevA && (BOARD_IS_FRDM_MCXW71_SCH_91744_RevA > 0)
/* FRDM-MCXW71 SCH-91744 RevA Ext Flash Chip Select is PCS3 and reset is PCS0 */
...
#else
/* FRDM-MCXW71 SCH-93847 RevA Ext Flash Chip Select is PCS0 and RST is PCS3 */
/* Current production FRDM-MCXW71 */
#define BOARD_EXTFLASH_CS_GPIO BOARD_INITEXTFLASHPINS_LPSPI1_PCS0_GPIO
#define BOARD_EXTFLASH_CS_PIN BOARD_INITEXTFLASHPINS_LPSPI1_PCS0_PIN

#define BOARD_EXTFLASH_RST_GPIO BOARD_INITEXTFLASHPINS_LPSPI1_PCS3_GPIO
#define BOARD_EXTFLASH_RST_PIN BOARD_INITEXTFLASHPINS_LPSPI1_PCS3_PIN

...
#define kSSCP_CMD_SSS_DigestImport                  ((sscp_command_t)0x82)
#define kSSCP_CMD_SSS_DigestExport                  ((sscp_command_t)0x83)
...
#define kSSCP_CMD_SSS_MacImport                     ((sscp_command_t)0x84)
#define kSSCP_CMD_SSS_MacExport                     ((sscp_command_t)0x85)

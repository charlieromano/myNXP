...
typedef bool_t (* hciToGenfskInterface_t)
(
    const hciPacketType_t packetType,     /*!< HCI Packet Type. */
    const void            *pPacket,       /*!< Pointer to packet payload. */
    const uint16_t        packetSize      /*!< Packet payload size. */
);

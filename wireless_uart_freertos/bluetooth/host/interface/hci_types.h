...
typedef enum
{
    ...
    gHciLePeriodicAdvSyncTransferReceivedV2_c       = 0x26,
    gHciLePeriodicAdvSubeventDataRequestEvent_c     = 0x27,
    gHciLePeriodicAdvResponseReportEvent_c          = 0x28,
    gHciLeEnhancedConnectionCompleteV2Event_c       = 0x29,
...
typedef enum
{
    ...
    gHciLePerAdvSyncTransferReceivedV2EventMask_c       = BIT64((4 * 8) + 5),
